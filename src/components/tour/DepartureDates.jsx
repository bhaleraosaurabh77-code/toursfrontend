...
// /* ---------------------------------------------------------
//    Departure data — dates are plain strings like "06 Sept 2026".
//    All 44 seats are available on every date for now.
// --------------------------------------------------------- */
...
//       onClick={() => onClick(departure)}
//       className={`
//         relative w-[168px] h-[152px] flex-shrink-0 rounded-xl border overflow-visible
//         transition-all duration-200 select-none cursor-pointer flex flex-col
//         ${isLowest
//           ? "bg-emerald-600 border-emerald-600"
//           : isSelected
...
//       `}
//     >
//       <div className={`text-center pt-3 text-[12px] font-semibold tracking-widest uppercase ${isLowest ? "text-white/90" : "text-gray-400"}`}>
//         {day}
//       </div>

//       <div className="text-center leading-none mt-2">
//         <div className={`text-[34px] font-extrabold leading-none ${isLowest ? "text-white" : "text-gray-900"}`}>
//           {date}
//         </div>
//         <div className={`text-[12px] font-medium mt-1 ${isLowest ? "text-white/85" : "text-gray-400"}`}>
//           {month}
//         </div>
//       </div>

//       <div className={`text-center text-[16px] font-semibold mt-2 ${isLowest ? "text-white" : "text-gray-800"}`}>
//         {currency(price)}
//       </div>

//       <div className="flex-1 flex items-end justify-center pb-2.5 px-1">
//         {isLowest && <span className="text-[11px] text-white font-semibold">Lowest Price</span>}
//       </div>
//     </div>
//   );
// }
...
//                 <span
//                   className={`w-5 h-5 rounded-full border flex items-center justify-center ${
//                     active ? "border-blue-900 bg-blue-950" : "border-gray-300 bg-white"
//                   }`}
//                 >
...
//         <div className="flex flex-wrap gap-5" key={refreshKey}>
//           {departures.map((d) => (
//             <DateTile
//               key={d.id}
//               departure={d}
//               isSelected={selectedId === d.id}
//               isLowest={d.price === lowestPrice}
//               onClick={handleSelect}
//             />
//           ))}
//         </div>
...
function DateTile({ departure, isSelected, isLowest, onClick }) {
  ...
  return (
    <div
      onClick={() => onClick(departure)}
      className={`
        relative w-[168px] h-[168px] flex-shrink-0 rounded-xl border overflow-visible
        transition-all duration-200 select-none cursor-pointer flex flex-col
        ${isLowest
          ? "bg-emerald-600 border-emerald-600"
          : isSelected
    ...
    >
      ...
      <div className={`text-center text-[11px] mt-1.5 ${isLowest ? "text-white/85" : "text-gray-500"}`}>
